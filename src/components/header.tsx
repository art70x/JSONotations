    ...
    <header className="fixed top-0 z-50 w-full border-b border-border/40 bg-background/60 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-10 text-sm font-medium text-muted-foreground md:flex">
          ...
          <Link to="/faq" className="group relative py-2 transition-colors hover:text-foreground">
            FAQ
            <span className="absolute bottom-0 left-0 h-0.5 w-0 bg-primary transition-all duration-300 group-hover:w-full" />
          </Link>
          <Link to="/help" className="group relative py-2 transition-colors hover:text-foreground">
            Help
            <span className="absolute bottom-0 left-0 h-0.5 w-0 bg-primary transition-all duration-300 group-hover:w-full" />
          </Link>
        </nav>
        <div className="flex items-center gap-4">
          <Link to="/editor">
            <Button className="button-hover-scale shadow-md shadow-primary/10">
              Go to Editor
              <IHugeiconsArrowRight02 className="size-5" />
            </Button>
          </Link>
        </div>
      </div>
